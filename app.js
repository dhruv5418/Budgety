...
var budgetController = (function (){
    ...
    return{
        ...
        calculateBudget:function(){
            ...
            // Calculate the udget income-expences
...
var UIController = (function(){
    ...
    return{
        ...
        addListItem: function(obj,type){
            ...
            // create HTML string with plaveholder text
            if(type==='inc'){
        ...
        clearFields: function(){
            ...
            fieldsArr.forEach(function name(current,index,array) {
                current.value="";
            });
            fieldsArr[0].focus();
        },
        displayBudget: function(obj){
            ...
            document.querySelector(DOMStrings.expenceLabel).textContent = formateNumber(obj.totalExp,'exp');
            if(obj.percentage>0){
...
var controller = (function(budgetCtrl,UIctrl){
    ...
    var ctrlDeleteItem = function(event){
        ...
        if(itemID){
            ...
            //3. Update the UI and show new budget
            updateBudget();
